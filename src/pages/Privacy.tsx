  ...
  <Layout>
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4">
        ...
        <p>At LiveZone TV, we respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information.</p>
        ...
        <p>LiveZone TV streams content from publicly available IPTV playlists. We do not host any video content on our servers. All streams are sourced from third-party providers.</p>
