  ...
  <Layout>
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4">
        ...
        <p>By using LiveZone TV, you agree to these Terms of Service. Please read them carefully.</p>
        <h2 className="text-xl font-display font-semibold text-foreground mt-8">Use of Service</h2>
        <p>LiveZone TV provides access to publicly available live TV streams and movie channels. The service is provided "as is" without any warranties.</p>
        <h2 className="text-xl font-display font-semibold text-foreground mt-8">Content</h2>
        <p>LiveZone TV does not host any video content. All streams are aggregated from publicly available sources. We are not responsible for the content of third-party streams.</p>
